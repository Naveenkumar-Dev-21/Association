...
const Dashboard = () => {
  ...
  const handleViewEvent = (eventId) => navigate(`/events`);
  const handleEditEvent = (eventId) => navigate(`/events`);
  const handleCreateEvent = () => navigate('/events/create');
  const handleSendNotification = () => navigate('/notifications');
